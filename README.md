...
## V1.3 — GAME FLOW PASS
- Раздача hole cards теперь визуально идёт по одной карте по кругу с читаемой паузой.
- Перед первым preflop action есть пауза: можно увидеть позиции, blinds и свою руку.
- Боты думают заметное время, а не щёлкают решения мгновенно.
- FLOP / TURN / RIVER разведены на отдельные визуальные фазы.
- Сбор ставок в pot замедлен и читается как отдельное действие.
